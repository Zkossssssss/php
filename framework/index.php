<?php
	...
	require_once $_SERVER['DOCUMENT_ROOT'] . '/php/framework/project/config/connection.php';
	...
	spl_autoload_register(function($class) {
		...
		$path = $_SERVER['DOCUMENT_ROOT'] . DIRECTORY_SEPARATOR . '/php/framework/' . $nameSpace . DIRECTORY_SEPARATOR . $className . '.php';
	...
	$routes = require $_SERVER['DOCUMENT_ROOT'] . '/php/framework/project/config/routes.php';
